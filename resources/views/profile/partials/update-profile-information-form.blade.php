<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" :value="old('phone', $user->profile?->phone)"
        ...
        <div>
            ...
            <x-text-input id="address_line1" name="address_line1" type="text" class="mt-1 block w-full"
                :value="old('address_line1', $user->profile?->address_line1)" required autofocus autocomplete="address_line1" />
